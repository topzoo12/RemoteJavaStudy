...
public class D09_CollectEmail {
	...
	*/
	...
	public static void main(String[] args) {
		...
		TreeSet<String> ddd = new TreeSet<String>();
		TreeSet<String> emailss = new TreeSet<String>();
...
//			System.out.println("찾은 것 : " + matcher.group());
			...
			emailss.add(matcher.group());
//			System.out.println("위치 : '" + matcher.start() + "' 부터 '" +  matcher.end() + "' 까지");
//			System.out.println(email.substring(matcher.start(), matcher.end()));
			
//			System.out.println("--");
			
//			Pattern check = Pattern.compile(email.substring(matcher.start(), matcher.end()));
			
//			int g = matcher.end();
			
//			ffff = email.substring(matcher.end(), matcher.la);
			
//			Matcher ma = check.matcher(email.substring(matcher.end()));
//			System.out.println(email.contains(email.substring(matcher.end(), email.length())));
			
//			email.contains(matcher.group());
//			if (email.contains(email.substring(matcher.start(), matcher.end()))) {
...
//			Matcher shit = check.matcher(ffff);
//			
//			if (shit.find()) {
//				ddd.add(shit.group());
//			}
...
//		String aaa = "abcdeds2@dfasdfewrzc";
//		
...
//		System.out.println(aaa.substring(matcher1.end(), aaa.length()));
		
//		System.out.println(emails.size());
		
//		for(int i = 0; i < emails.size(); i++) {
//			
//			if (i < (emails.size() - 1) && (emails.get(i).equals(emails.get(i+1)))) { 
//				ddd.add(emails.get(i));
...
//			System.out.println(emails.get(i));
		...
		System.out.println(emails.size());
		System.out.println(emailss.size());
